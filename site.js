...
const topics = [
  ...
  { id:'settings', label:'설정', title:'설정하는 시간도 편안하게.', sub:'설정 검색 · 되돌리기 · 미리보기 확대 · 변경한 설정 · 즐겨찾기 · 백업 · 숫자 쉼표 · 확장 서랍', cards: [
    ...
    P('commas', '128,000처럼 쉼표로', '큰 숫자는 끊어 보여서 컨텍스트를 헷갈리지 않아요. 폰에서도 설정은 두 칸.'),
