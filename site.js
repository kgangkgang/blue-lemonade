...
const topics = [
  ...
  { id:'weather', label:'날씨', fresh:true, title:'오늘의 장면에, 오늘의 날씨.', sub:'안개 · 햇살 · 별 · 반딧불이 · 무지개 · 나무 그림자 · 물결 · 유리 빗방울 · 두 날씨 혼합 · 비 · 눈 · 유성우 · 내 그림', cards: [
    ['433-look-milkyway.mp4','은하수 위를 도는 유성','별(은하수 · 두 색 그라데이션) + 유성(곡률 95 · 원 크기 130). 날씨 혼합하기로 두 가지를 겹쳐요.','433-look-milkyway.jpg'],
    ['433-look-mist.mp4','구름 띠와 아침 볕','안개(애니풍 구름 띠 · 아래) + 햇살(성스러운 빛 · 따뜻한 두 색).','433-look-mist.jpg'],
    ['433-look-moonsea.mp4','밤바다와 은하수','물결(바다 · 아래) + 별(은하수). 내 메시지에도 날씨가 비쳐요.','433-look-moonsea.jpg'],
    ['433-look-petalsun.mp4','꽃잎과 봄볕','꽃잎(흔들림 150 · 속도 65) + 햇살(애니풍).','433-look-petalsun.jpg'],
    ['433-look-seaside.mp4','바닷가의 빛줄기','물결(바다) + 햇살(빛줄기 · 옅은 노랑).','433-look-seaside.jpg'],
    ['433-look-snownight.mp4','별 뜬 밤의 눈','눈(크기 90 · 속도 55 · 흔들림 140) + 별(반짝이는 별).','433-look-snownight.jpg'],
    ['433-look-fireflies.mp4','안개 낀 숲의 반딧불이','반딧불이(크기 120 · 노랑→연두) + 안개(실안개 · 아래).','433-look-fireflies.jpg'],
    ['433-look-rainyglass.mp4','비 오는 창가','유리 빗방울은 작게(크기 50 · 세기 강하게)가 예뻐요. + 안개(위쪽 · 옅게).','433-look-rainyglass.jpg'],
    ['433-look-afterrain.mp4','비 갠 뒤','무지개(자리를 끌어 옮김) + 햇살(빛줄기).','433-look-afterrain.jpg'],
