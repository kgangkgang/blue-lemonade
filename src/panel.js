...
const SUBS = {
    ...
    extensions: [['words', '단어 치환'], ['capture', '채팅 캡처'], ['order', '확장 순서'], ['perf', '성능 보조'], ['models', '모델 등록'], ['modelorder', '모델 순서'], ['bookmarks', '북마크'], ['modelswitch', '모델 전환'], ['regexlink', '프롬프트 연동 정규식'], ['rewrite', '다시 쓰기'], ['scripts', '스크립트']],
};
