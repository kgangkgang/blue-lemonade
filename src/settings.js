...
export const DEFAULTS = {
    ...
    customPalettes: [],
    activeCustomPalette: '',
    addons: { assets: false, order: false, perf: false, words: false, capture: false, models: false, modelorder: false, modelswitch: false, regexlink: false, rewrite: false, bookmarks: false, translator: false, prompt: false, customstyle: false, conflicts: false },
