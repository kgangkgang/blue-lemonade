...
const rows = [
 ['extensions','prompt','한글화 패널','실리태번 헬퍼 데우스 샤진 거문고 한글화 프리셋 월드인포 봇카드 정규식 번역'],
 ['chat','etc','펼친 카드 아래에 접기 버튼','삼각형 접기 카드 아래 접기','', 'chat.triangleFold'],
 ['extensions','prompt','한글화 패널','프리셋 월드인포 봇카드 번역 제목 검색 사용방법'],
 ['extensions','customstyle','커스텀 CSS 조절','IceFog 색 변수 슬라이더 입력 커스텀 스타일'],
 ...
 ['chat','screen','큰 숫자는 쉼표로','숫자 쉼표 천 단위 자릿수 구분 콤마 30,000 컨텍스트 최대 토큰 숫자 칸 입력칸', '', 'chat.numComma'],
...
rows.push(['extensions','words','단어 치환','단어 바꾸기 조사 규칙 되돌리기'],['extensions','capture','채팅 캡처','이미지 사진 저장 메시지 다중 선택'],['extensions','order','확장 순서','패널 고정 순서 정렬'],['extensions','perf','성능 보조','끊김 감시 요청 로그 로딩 저장 정리'],['chat','screen','날씨 움직임','레몬 꽃잎 유성 낙하 회전 흔들림 커스텀'],['theme','palette','내 에이드 보관함','커스텀 여러개 저장 불러오기'],
 ...
 ['theme','etc','사용 모드','테마만 확장만 테마 확장 함께 실행 기타 설정'],
