...
export const SCRIPT_CATALOG = [
  {id:'korean',name:'실리태번 한글화',version:'1.4.2',icon:'fa-language',description:'남아 있는 영어 메뉴와 기본 안내를 한글로 보여요. 대화와 입력한 값은 그대로예요.',match:['__sillyTavernKoreanUI_v1'],file:'korean'},
