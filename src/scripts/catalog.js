...
export const SCRIPT_CATALOG = [
  {id:'korean',name:'실리태번 한글화',version:'1.4.1',icon:'fa-language',description:'남아 있는 영어 메뉴와 기본 안내를 한글로 보여요. 대화와 입력한 값은 그대로예요.',match:['__sillyTavernKoreanUI_v1'],file:'korean'},
  ...
  {id:'fold',name:'▲ 삼각형 접기',version:'1.0.1',icon:'fa-caret-up',description:'펼친 채팅 카드 아래에서 바로 접어요. 북마크·메시지 미리보기와 접근 가능한 채팅 iframe에도 적용돼요.',match:['__thkFold'],file:'fold'},
];
