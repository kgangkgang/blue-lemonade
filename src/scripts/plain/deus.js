...
BlueLemonade.translate({
  ...
  "prompts": [
    ...
    {
      "id": "1bbb1b67-520c-4730-96d7-9674f794538b",
      "name": "「 Extra Long 」",
      "title": "「 아주 길게 」",
      "desc": "아주 긴 답변. 본문 1000~1600단어, 8~14문단. 1000단어 아래로는 끝내지 않고, 일찍 마무리될 것 같으면 감각 묘사 · 내면 반응 · 대사 한 박자를 더 넣어 채웁니다. '길이' 항목에서 하나만 고릅니다."
    },
    {
    ...
    {
      "id": "f155f1d8-34be-4ef3-98e3-c63fbd8cec48",
      "name": "「 Romantic」",
      "title": "「 로맨틱 」",
      "desc": "로맨틱한 분위기를 더합니다. 거리 · 머뭇거림 · 시선 · 말끝을 흐리는 대사 · 작은 몸짓으로 두 사람 사이의 긴장을 쌓고, 감정은 선언이 아니라 장면으로 천천히 쌓아 갑니다. '코믹'과 함께 켜면 로맨틱 코미디, '드라마틱'과 함께 켜면 멜로가 됩니다."
    },
    {
