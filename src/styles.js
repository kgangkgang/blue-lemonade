...
export const STYLE_KEYS = ['palette', 'customName', 'colorOverrides', 'fonts', 'type', 'dialogue', 'ui', 'code', 'em', 'strong', 'shadow', 'chat', 'image', 'profile'];
...
export function applyStyleData(s, data) {
    ...
    for (const key of STYLE_KEYS) {
        ...
        if ((key === 'chat' || key === 'image' || key === 'profile') && isObj(value)) {
