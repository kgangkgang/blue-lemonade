...
const topics = [
  ...
  { id:'weather', label:'날씨', fresh:true, title:'오늘의 장면에, 오늘의 날씨.', sub:'안개 · 햇살 · 별 · 반딧불이 · 무지개 · 나무 그림자 · 물결 · 유리 빗방울 · 두 날씨 혼합 · 비 · 눈 · 유성우 · 내 그림', cards: [
    ['430-look-milkyway.mp4','은하수 위로 유성이','별(은하수 · 두 색 그라데이션) + 유성(곡률 45). 날씨 혼합하기로 두 가지를 겹쳐요.','430-look-milkyway.jpg'],
    ['430-look-dapple.mp4','야자 잎 사이로 드는 빛','나무 그림자(야자 잎 · 크기 60 · 흐리기 4, 두 가지를 떨어뜨려 놓기) + 햇살(성스러운 빛 · 따뜻한 두 색).','430-look-dapple.jpg'],
    ['430-look-moonsea.mp4','밤바다와 은하수','물결(바다 · 아래) + 별(은하수). 내 메시지도 날씨가 비쳐요.','430-look-moonsea.jpg'],
    ['430-look-palm.mp4','수영장의 오후','나무 그림자(야자 잎) + 물결(수영장 · 아래).','430-look-palm.jpg'],
    ['430-look-petalsun.mp4','꽃잎과 봄볕','꽃잎(흔들림 150 · 속도 65) + 햇살(애니풍).','430-look-petalsun.jpg'],
    ['430-look-seaside.mp4','바닷가의 빛줄기','물결(바다) + 햇살(빛줄기 · 옅은 노랑).','430-look-seaside.jpg'],
    ['430-look-fireflies.mp4','안개 낀 숲의 반딧불이','반딧불이(크기 120 · 노랑→연두) + 안개(실안개 · 아래).','430-look-fireflies.jpg'],
    ['430-look-rainyglass.mp4','비 오는 창가','유리 빗방울은 작게(크기 50 · 세기 강하게)가 예뻐요. + 안개(위쪽 · 옅게).','430-look-rainyglass.jpg'],
    ['430-look-afterrain.mp4','비 갠 뒤','무지개 + 흩날림.','430-look-afterrain.jpg'],
